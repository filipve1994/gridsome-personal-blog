<template>
    <Layout>
        ...
        >
            ...
            >
                <!--        <div class="leading-tight">{{ $static.metadata.siteName }} Gridsome Portfolio Starter</div>-->
                <div class="leading-tight">{{ $static.metadata.siteName }}</div>
                <div class="text-green-700 leading-tight">
                    Powered by Vue.js &amp; Tailwind v2
                </div>
            </div>
        ...
        <div class="container-inner mx-auto">
            <p class="text-lg sm:text-xl">
                ...
                <a href="https://andremadarang.com">personal website</a>. I
                added more features and decided to release it as an open source
                project. Check it out on
                <a
                ...
                <a href="https://www.youtube.com/watch?v=uHo6o1TNQeE"
                    >screencast I did</a
                >. Feel free to use it for your own site or projects! Lorem,
                ipsum dolor sit amet consectetur adipisicing elit. Minima,
                repellat. Dolores iure, quas perspiciatis rerum quaerat atque
                eum repellat autem.
            </p>
                ...
                <ul class="text-lg sm:text-xl space-y-6">
                    <li class="checkmark">
                        ...
                        <div class="text-lg text-gray-600">
                            ...
                            elit. Qui ab nam animi iure nemo exercitationem a,
                            eius non culpa itaque!
                        </div>
                    </li>
                    <li class="checkmark">
                        <div>Project Two</div>
            ...
            >
                ...
                >
                    ...
                    <div class="flex-1 text-lg sm:text-xl ml-6">
                        Lorem ipsum dolor sit amet consectetur, adipisicing
                        elit. Eum quae architecto minus molestias iusto ducimus
                        fuga quo quia libero dignissimos, fugiat modi assumenda
                        debitis laboriosam.
                    </div>
                </div>
        ...
        <div class="overflow-x-hidden">
            <div class="contact-me bg-background-secondary pt-16">
                <div class="container-inner mx-auto text-xl pb-4 relative">
                    ...
                    <p class="mb-12">
                        Static sites cannot submit forms on their own. However,
                        services like
                        <a href="https://www.netlify.com/docs/form-handling"
                            >Netlify Forms</a
                        >
                        or <a href="https://formspree.io">FormSpree</a> can help
                        you do this without a backend.
                    </p>
        ...
        <div class="newsletter bg-background-tertiary">
            <div
                class="container-inner mx-auto py-16 pb-8 text-center textl-xl"
            >
                ...
                <div class="w-4/5 mx-auto mb-8">
                    <p class="mb-8 text-lg sm:text-xl">
                        Lorem ipsum dolor, sit amet consectetur adipisicing
                        elit. Corporis, voluptatum. Quam, deleniti nulla.
                    </p>
